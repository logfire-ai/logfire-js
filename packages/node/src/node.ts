...
export class Node extends Base {
  /**
   * Readable/Duplex stream where JSON stringified logs of type `ILogfireLog`
  ...
  public async log<TContext extends Context>(
    ...
    return processedLog as ILogfireLog & TContext;
  }

  /**
   * Pipe JSON stringified `ILogfireLog` to a stream after syncing
   *
