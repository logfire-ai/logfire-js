...
import { ILogfireOptions, LogLevel } from '@logfire-sh/types';
...
class KoaLogfire extends Logfire {
  protected _koaOptions: IKoaOptions;

  public constructor(
    sourceToken: string,
    logfireOpt?: Partial<ILogfireOptions>,
    koaOpt?: Partial<IKoaOptions>
  ) {
    super(sourceToken, logfireOpt);
  ...
  /**
   * Attach Logfire's Koa middleware handler to a Koa instance
   *
